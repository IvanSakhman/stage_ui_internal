...
const SmartTable = ({ title, columnsConfig, pagination, filters, urlParams, dataKey = '', ...rest }) => {
  const columns = buildColumns(columnsConfig.columns, urlParams, filters).map((column) => {
