...
const Layout = ({ menuProps, sidebarItems, children, onSideMenuSelect, themeOverrides = {} }) => {
  ...
  return (
    <StyledLayout>
      ...
      <AntdLayout>
        <SideMenu sidebarItems={sidebarItems} onSideMenuSelect={onSideMenuSelect} themeToken={themeToken} />
        <AntdLayout>
          <GlobalAlert />
